...
extern mp_obj_t picographics_draw_raw_chunk(size_t n_args, const mp_obj_t *args);
MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(ModPicoGraphics_draw_raw_chunk_obj, 3, 5, picographics_draw_raw_chunk);
// Layers
...
static const mp_rom_map_elem_t ModPicoGraphics_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_draw_raw_chunk), MP_ROM_PTR(&ModPicoGraphics_draw_raw_chunk_obj) },
